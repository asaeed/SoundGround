...
public class ParamBox implements ControlListener{
	...
	private Textlabel _frameRateLabel;
	public ParamBox(SoundGround appRef)
	{
		...
		_frameRateLabel = controlP5.addTextlabel("FrameRate", "99999", 100, 100);
		controlP5.show();
	...
	public void draw()
	{
		_frameRateLabel.setValue(String.format("%.2f", app.frameRate));
		controlP5.draw();	
	}
